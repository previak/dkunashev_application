...
* Точная версия будет зависить от финальной версии проекта
...
* Ознакомление с тонкостями поступления в каждый из предложенных классов (9-10).
